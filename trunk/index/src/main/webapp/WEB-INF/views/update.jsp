...
<body>
	<b>Update....</b>
	<%@page
		import="java.util.*,wli.java.db.*,wli.java.stigs.Stig,java.util.*,java.sql.Date,wli.java.web.util.*;"%>
	...
	<%
		...
		if (action_id != null && action_id.equals("search_by_finding_id")) {
			out.println("search all server FINDING_ID=" + stig.getFindingId());
		}
		...
		if (action_id != null && action_id.equals("edit_all")) {
			...
			out.println("<td>" + HtmlForm.getSelect("status", "OPEN;CLOSED;N/A", ";", false, status, "") + "</td>");
			...
			out.println("<tr><td>");
			out.println(HtmlForm.getTextArea("note", 80, 20));
			out.println("</td></tr>");
			out.println("</table>");
